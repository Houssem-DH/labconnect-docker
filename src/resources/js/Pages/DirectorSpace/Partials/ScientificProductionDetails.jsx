...
const ScientificProductionDetails = ({ production }) => {
    ...
    const handleDelete = () => {
        deleteRequest(`/director-space/scientific-productions/delete/${production.id}`);
        onClose();
    };
        ...
        switch (production.type) {
            case "Journal":
                return (
                    <>
                        <p>
                            <Globe className="inline-block mr-2" /> <strong>Volume:</strong>{" "}
                            {production.journal?.[0]?.volume}
                        </p>
                        <p>
                            <Globe className="inline-block mr-2" /> <strong>Number:</strong>{" "}
                            {production.journal?.[0]?.number}
                        </p>
                        <p>
                            <FileText className="inline-block mr-2" /> <strong>Pages:</strong>{" "}
                            {production.journal?.[0]?.Pages}
                        </p>
                        <p>
                            <Link className="inline-block mr-2" /> <strong>DOI:</strong>{" "}
                            {production.journal?.[0]?.doi}
                        </p>
                    </>
                );
            case "Proceeding":
                return (
                    <>
                        ...
                        <p>
                            <Edit3 className="inline-block mr-2" /> <strong>Editors:</strong>{" "}
            ...
            case "Chapter":
                return (
                    <>
                        ...
                        <p>
                            <BookOpen className="inline-block mr-2" /> <strong>Edition:</strong>{" "}
                        ...
                        <p>
                            <Globe className="inline-block mr-2" /> <strong>Country:</strong>{" "}
                        ...
                        <p>
                            <File className="inline-block mr-2" /> <strong>ISBN:</strong>{" "}
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        ...
                                        permanently delete the Scientific Production and
