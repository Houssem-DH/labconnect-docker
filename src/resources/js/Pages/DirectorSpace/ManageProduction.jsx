...
import GlobalReportCard from "./Partials/GlobalReportCard"; // Assuming you want global reporting
import PersonalReportCard from "./Partials/PersonalReportCard"; // Assuming personal reporting is included
        ...
        if (props.flash.message) {
            ...
            switch (props.flash.message) {
                case "Production added successfully":
                    ...
                    variant = "default";
                    break;
                case "Author removed successfully":
                    icon = <CheckCircle className="w-6 h-6 text-green-500" />;
                    variant = "default";
                    break;
