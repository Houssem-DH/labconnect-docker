...
import ManageLabModal from "./Partials/Modals/ManageLabModal";
...
import UploadBackgroundModal from "./Partials/Modals/UploadBackgroundModal";
                        ...
                        >
                            ...
                            {isHovered && (
                                <div className="absolute top-2 right-2">
                                    <button
                                        className="bg-main rounded-full p-2 text-white hover:bg-gradient-to-r hover:bg-red-800 "
