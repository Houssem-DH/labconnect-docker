...
const GlobalReportCard = ({ globalReport, project }) => {
        ...
        <Card className="border border-gray-300 shadow-lg rounded-lg bg-white overflow-hidden">
            ...
            <CardContent className="p-6">
                <div className="flex justify-end mb-6">
                    {!globalReport && (
                        ...
                        >
                            <FiPlus className="w-5 h-5 mr-2" /> Add A Global Report
                        </Button>
                    )}
                </div>
                ...
                {globalReport ? (
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <div className="font-medium text-gray-900 text-lg">
                                    {globalReport.user.first_name} {globalReport.user.last_name}
                                </div>
                    ...
                    <p className="text-gray-500">No report available. Please add a report.</p>
                )}
            </CardContent>
            ...
            {isEditModalOpen && (
                <AddGlobalReportModal
                    ...
                    project={project}
                    globalReport={globalReport} // Pass the existing report for editing
                />
            )}
        </Card>
    );
