...
const AddLabMemberModal = ({ onClose, project, lab_members, externalMembers}) => {
    ...
    const [valueExternal, setValueExternal] = useState("");
    const [selectedExternal, setSelectedExternal] = useState(null);

    const handleSubmit = (e) => {
        e.preventDefault();

        post(route("project.leader.project.member.insert", { id: project.id }), {
            onSuccess: () => onClose(),
        });
    };
            ...
            <DialogContent className="max-w-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        <div>
                            ...
                            <Select onValueChange={handleOptionChange}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="existing_external">
                                        {language === "en"
                                            ? "Existing External Member"
                                            : language === "ar"
                                            ? "عضو خارجي"
                                            : "Membre externe"}
                                    </SelectItem>

                                    <SelectItem value="new_external">
                                        {language === "en"
                                            ? "New External Member"
                                            : language === "ar"
                                            ? "عضو خارجي"
                        ...
                        {selectedOption === "existing_external" && (
                            <div>
                                <Label htmlFor="external_id">
                                    {language === "en"
                                        ? "Select External Member"
                                        : language === "ar"
                                        ? "اختر عضو مختبر"
                                        : "Sélectionnez un membre du laboratoire"}
                                </Label>
