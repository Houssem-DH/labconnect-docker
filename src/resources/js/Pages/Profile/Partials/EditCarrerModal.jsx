...
const EditCarrerModal = ({ isOpen, onClose, career }) => {
    const [formData, setFormData] = useState({
        yeare: career.year,
        unive: career.univ,
        specialitye: career.speciality,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("Profile.Carrer.Edit", { id: career.id }), {
            onSuccess: () => {
                onClose();
            },
        });
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                name="yeare"
                                value={data.yeare}
                                onChange={(e) => setData("yeare", e.target.value)}
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                name="unive"
                                value={data.unive}
                                onChange={(e) => setData("unive", e.target.value)}
                                className="w-full px-4 py-3 border rounded-md focus:outline-none focus:border-gray-500"
                            />
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                id="specialitye"
                                name="specialitye"
                                value={data.specialitye}
                                onChange={(e) => setData("specialitye", e.target.value)}
                                className="w-full px-4 py-3 border rounded-md focus:outline-none focus:border-gray-500"
                            />
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                className="bg-gray-800 text-white-300 px-6 py-3 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-700"
                            >
                                Edit Career
                            </button>
                        </div>
...
export default EditCarrerModal;
