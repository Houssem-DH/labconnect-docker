...
const UploadBackgroundModal = ({ isOpen, onClose }) => {
    ...
    const submit = (e) => {
        ...
        formData.append("background_photo", data.background_photo); // Append the avatar file to the form data
        post(
            route(
                "profile.update.profile.background",
                { id: user.id }    
            ),
            formData
        );
