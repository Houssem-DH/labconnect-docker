...
const MemberDeleteModal = ({ member, sc, onClose }) => {
    const { delete: deleteRequest } = useForm();

    const handleDelete = () => {
        // Wrap the deleteRequest call inside a callback function
        deleteRequest(
            `/team-leader-space/manage-lab/manage-team/manage-scientific-production/delete-scientific-production-author/${sc.id}/${member.id}/`
        );
        onClose();
    };
