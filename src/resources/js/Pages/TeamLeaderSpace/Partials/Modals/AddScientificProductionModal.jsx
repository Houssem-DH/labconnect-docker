...
const AddScientificProductionModal = ({ isOpen, onClose, user }) => {
    ...
    const submit = (e) => {
        ...
        post(
            route("team.leader.space.scientific.productions.insert", {
                id: user.id,
            }),
            {
                onSuccess: () => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-3xl overflow-y-scroll max-h-screen p-6">
                <DialogHeader>
                    <DialogTitle>Add Scientific Production</DialogTitle>
                    <DialogDescription>
