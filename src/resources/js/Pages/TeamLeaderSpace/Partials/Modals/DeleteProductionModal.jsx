...
const MemberDeleteModal = ({ production, onClose,team }) => {
    const { delete: deleteRequest } = useForm();

    const handleDelete = () => {
        // Wrap the deleteRequest call inside a callback function
        deleteRequest(`/team-leader-space/manage-lab/manage-team/delete-scientific-production/${production.id}/${team.id}`);
        onClose();
    };
