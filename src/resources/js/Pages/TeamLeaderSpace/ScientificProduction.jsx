...
const ScientificProduction = ({ scientificProductions, auth, userRole }) => {
    ...
    useEffect(() => {
        if (props.flash.message) {
            switch (props.flash.message) {
                case "Scientific Production Added Successfully":
                case "Scientific Production Updated Successfully":
                case "Scientific Production Deleted Successfully":
                    toast.success(props.flash.message);
                    break;
                case "Scientific Production Already Exists":
                                ...
                                >
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <button className="text-main hover:text-red-700">
                                                    <Link
                                                        href={route(
                                                            "team.leader.team.scientific.production.manage",
                                                            production.id
                                                        )}
                                                    >
                                    ...
                                    <CardContent className="p-4 bg-white">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <Button
                                                onClick={() => toggleDetails(production.id)}
                                                variant="outline"
                                        ...
                                        {detailsId === production.id && (
                                            <div className="mt-4 text-sm text-gray-700">
                                                ...
                                                <p className="mb-2">
                                                    ...
                                                    >
                                                        {production.url || "No URL available"}
                                                    </a>
                                                </p>
                                                <p className="mb-2">
                                                    <strong>Year of Publication:</strong>{" "}
                                                    {new Date(production.year_publication).toLocaleDateString()}
                                                </p>
                                            </div>
                                        )}
                                    </CardContent>
