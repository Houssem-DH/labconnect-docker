...
const Navbar = () => {
    ...
    return (
        <div className="flex justify-center mb-8 space-x-4">
            ...
            {/* Teams */}
            <Link
                href="/team-leader-space/teams"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/team-leader-space/teams"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Phd Thesis */}
            <Link
                href="/team-leader-space/phd-thesis"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/team-leader-space/phd-thesis"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Members */}
            <Link
                href="/team-leader-space/members"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/team-leader-space/members"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Projects */}
            <Link
                href="/team-leader-space/projects"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url.includes("/team-leader-space/projects")
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
                <LineChart className="h-6 w-6 mr-2 font-medium" />
                <span className="nav-label">Projects</span>
            </Link>

            {/* Materials */}
            <Link
                href="/team-leader-space/materials"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/team-leader-space/materials"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            <Link
                href="/team-leader-space/scientific-productions"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/team-leader-space/scientific-productions"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
