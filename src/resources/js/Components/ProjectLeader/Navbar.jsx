...
const Navbar = () => {
    ...
    return (
        <div className="flex justify-center mb-8 space-x-4">
            ...
            {/* Projects */}
            <Link
                href="/project-leader-space/projects"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/project-leader-space/projects"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Members */}
            <Link
                href="/project-leader-space/members"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/project-leader-space/members"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Teams */}
            <Link
                href="/project-leader-space/teams"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/project-leader-space/teams"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
            ...
            {/* Materials */}
            <Link
                href="/project-leader-space/materials"
                className={cn(
                    "nav-btn border border-gray-600 px-6 py-3 rounded-lg flex items-center transition-colors duration-300 font-medium",
                    url === "/project-leader-space/materials"
                        ? "bg-main text-white"
                        : "hover:bg-main hover:text-white"
                )}
            >
