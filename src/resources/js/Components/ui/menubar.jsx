...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-14 items-center space-x-1 rounded-md border bg-background ",
      className
    )}
    {...props} />
))
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-pointer select-none items-center rounded-sm px-3 py-3.5 text-sm font-medium outline-none ",
      className
    )}
    {...props} />
))
