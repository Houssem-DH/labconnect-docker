            ...
            (u = oe.select =
                function(e, t, n, i) {
                    ...
                    if (((n = n || []), 1 === d.length)) {
                        ...
                        for (
                            o = V.needsContext.test(e) ? 0 : u.length; o-- && ((c = u[o]), !r.relative[(l = c.type)]);
            ...
            if (v && (u = v.events)) {
                for (c = (t = (t || "").match(R) || [""]).length; c--;)
                    if (
                        ...
                        for (d in u) m.event.remove(e, d + t[c], n, r, !0);
    ...
    m.each({
        ...
        m.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = be),
                    this.each(function() {
    ...
    function Me(e, t, n) {
        ...
        return (
            ...
            ("" !== (a = n.getPropertyValue(t) || n[t]) ||
                m.contains(e.ownerDocument, e) ||
                (a = m.style(e, t)), !h.pixelMarginRight() &&
                Pe.test(a) &&
                Oe.test(t) &&
                ((r = s.width),
                    (i = s.minWidth),
        ...
        m.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, r, i = e.options, o = m.makeArray(t), a = i.length; a--;
            ...
            trigger: function(t, n, i, o) {
                ...
                if (
                    ...
                    if (!o && !d.noBubble && !m.isWindow(i)) {
                        for (
                            c = d.delegateType || g, dt.test(c + g) || (s = s.parentNode); s; s = s.parentNode
                        )
                            h.push(s), (u = s);
                        u === (i.ownerDocument || r) &&
            ...
            ajax: function(t, n) {
                    ...
                    E = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (l) {
                                if (!s)
                                    for (s = {};
                                        (t = kt.exec(a));) s[t[1].toLowerCase()] = t[2];
                                t = s[e.toLowerCase()];
                            }
                ...
                for (p in ((f = m.event && h.global) &&
                        ...
                        ((d = h.url.slice(o.length)),
                            h.data && ((o += (vt.test(o) ? "&" : "?") + h.data), delete h.data), !1 === h.cache &&
                            ((o = o.replace(Et, "$1")),
                                (d = (vt.test(o) ? "&" : "?") + "_=" + gt++ + d)),
                            (h.url = o + d)),
                        h.ifModified &&
    ...
    m.ajaxSetup({
        ...
        m.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && "static" === m.css(e, "position");
